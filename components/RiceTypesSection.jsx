    ...
    <section id="rice-types" aria-labelledby="rice-types-title" className="bg-white">
      ...
      <div aria-labelledby="distributors-title" className="mx-auto max-w-[1280px] px-[8%] pt-[8%] pb-[10%] min-[640px]:pt-[1%] min-[640px]:pb-[3.5%]">
        ...
        <div className="mt-[9%] flex items-center justify-center gap-[10%] min-[640px]:mt-[3%] min-[640px]:gap-[7%]">
          <Image src="/media/Arshman Logo.png" alt="Arshman Rice" width={1254} height={1254} className="h-auto w-[40%] object-contain min-[640px]:w-[16%]" sizes="(max-width: 639px) 34vw, (max-width: 1280px) 14vw, 180px" />
          <Image src="/media/Mahmood Logo.png" alt="Mahmood Rice" width={1254} height={1254} className="h-auto w-[40%] object-contain min-[640px]:w-[16%]" sizes="(max-width: 639px) 34vw, (max-width: 1280px) 14vw, 180px" />
        </div>
      </div>
    </section>
  );
